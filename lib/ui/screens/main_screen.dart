        ...
        body: Stack(
          ...
          children: [
             Image.asset("assets/images/background_world.png",
                fit: BoxFit.cover, color: Colors.blue.withOpacity(.1)),
            ListView(
    ...
    return CupertinoButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(blurRadius: 25, color: primaryColor.withOpacity(.10))
          ],
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
                left: 8,
                child: IconButton(
                    onPressed: _menuClick,
                    icon: Image.asset("assets/animations/menu.png",height : 45,)
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                icon: Image.asset("assets/animations/premium.png"),
                //color: Colors.red,
              ),
            ),
          ],
